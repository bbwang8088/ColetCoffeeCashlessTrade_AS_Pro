...
public class CircleLoader extends View {
	...
	public CircleLoader(Context context, AttributeSet attrs) {
		...
		// circleColor = (int)a.getColor(R.styleable.circleloader_circleColor,
		// 0);
		// if(circleColor == 0)
		// circleColor = a.getResourceId(R.styleable.circleloader_circleColor,
		// 0);
		// if(circleColor == 0)
		circleColor = 0xFFFFFFFF;// 0xFF2E7FA9
...
//		FontMetricsInt fontMetrics = paint.getFontMetricsInt();
	...
	private void drawCircle(Canvas canvas, int top) {
		...
		canvas.drawArc(oval, startAngle, 330, false, paint);
	}
